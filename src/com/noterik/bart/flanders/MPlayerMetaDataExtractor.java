...
import com.noterik.bart.flanders.homer.FlandersProperties;
import com.noterik.bart.flanders.tools.HttpHelper;
...
public class MPlayerMetaDataExtractor {	
	...
	public static String extractMetaData(String source) {
		FlandersProperties fp = com.noterik.bart.flanders.homer.LazyHomer.getMyFlandersProperties();
